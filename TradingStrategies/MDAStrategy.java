...
public class MDAStrategy {
	...
	public void initialize (Portfolio port, DataCollection dc, String startDate, DateModifications dm) {
	...
	private double computeLongRunAverage (Portfolio port, DataCollection dc, int stockIndex, String stockDate, DateModifications dm) {
	...
	// as date decrements, average updates
	private double computeShortRunAverage (Portfolio port, DataCollection dc, int stockIndex, String stockDate, DateModifications dm) {
	...
	private boolean compareAveragesToBuy(double shortRunAverage, double longRunAverage, double yestShortRunAverage, double yestLongRunAverage) {
	
		return (yestShortRunAverage < yestLongRunAverage && shortRunAverage > longRunAverage);
	}
	
	// method to compare shortrun/longrun average of given date, as well as previous date
	// if short run crosses down long run in given day, indicates that stock should be sold [true]
	private boolean compareAveragesToSell(double shortRunAverage, double longRunAverage, double yestShortRunAverage, double yestLongRunAverage) {
